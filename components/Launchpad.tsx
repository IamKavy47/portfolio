...
export default function MacLaunchpad() {
  ...
  const apps: App[] = [
    ...
    { id: "mail", name: "Mail", icon: "/Icon/mail.jpg"},
    ...
    { id: "facetime", name: "FaceTime", icon: "/Icon/facetime.svg" },
    { id: "calendar", name: "Calendar", icon: "/Icon/Calendar.png" },
    { id: "contacts", name: "Contacts", icon: "/Icon/Contacts.png" },
    { id: "reminders", name: "Reminders", icon: "/Icon/reminder.jpg" },
    { id: "notes", name: "Notes", icon: "/Icon/notes.jpg" },
    { id: "music", name: "Music", icon: "/Icon/Music.png" },
    { id: "podcasts", name: "Podcasts", icon: "/Icon/podcast.jpg" },
    { id: "tv", name: "TV", icon: "/Icon/appletv.svg" },
    { id: "news", name: "News", icon: "/Icon/news.svg" },
    { id: "appstore", name: "App Store", icon: "/Icon/appstore.svg" },
    { id: "books", name: "Books", icon: "/Icon/books.svg" },
    { id: "weather", name: "Weather", icon: "/Icon/weather.jpg" },
    { id: "stocks", name: "Stocks", icon: "/Icon/stocks.jpg" },
    { id: "home", name: "Home", icon: "/Icon/home.svg" },
    { id: "voice-memos", name: "Voice Memos", icon: "/Icon/voicememo.svg" },
    { id: "calculator", name: "Calculator", icon: "/Icon/calc.svg" },
    { id: "Passwords", name: "Passwords", icon: "/Icon/passwords.jpg" },
  ]
