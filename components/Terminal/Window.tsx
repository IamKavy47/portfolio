...
export default function Window({
  ...
  return (
    ...
    >
      <div
        className="bg-[#3c3c3c] px-4 py-2 flex justify-between text-white border-none items-center cursor-move select-none"
      ...
      <div className="relative" style={{ height: "calc(100% - 25px)", overflow: "hidden" }}>
        {children}
      </div>
    </motion.div>
  )
