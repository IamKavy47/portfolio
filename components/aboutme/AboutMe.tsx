...
export default function AboutMe({ onClose, onFocus }: AboutMeProps) {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "A Award winning website clone using html, css, js and gsap.",
      image: "",
      technologies: ["HTML", "CSS", "JS", "GSAP"],
      githubUrl: "https://github.com/iamkavy47/wte",
      liveUrl: "https://wte-six.vercel.app",
      date: "April 2025",
      gradient: "",
      icon: "",
    },
    {
      title: "GTA VI Style Landing PAge",
      description:
        "A GTA VI Style Landing page using html css js and gsap with cool loading animation.",
      image: "",
      technologies: ["HTML", "CSS", "JS", "GSAP"],
      githubUrl: "https://github.com/iamkavy47/Gtavi",
      liveUrl: "https://gtalanding.vercel.app",
      date: "May 2025",
      gradient: "",
      icon: "",
    },
